        ...
        <tbody>
          <tr>
           <% 
            ...
            if(con!=null)
            {
                String query="SELECT 2017_ece.*,2017_ece_sem2.s1,2017_ece_sem2.g1,2017_ece_sem2.s2,2017_ece_sem2.g2,2017_ece_sem2.s3,2017_ece_sem2.g3,2017_ece_sem2.s4,2017_ece_sem2.g4,2017_ece_sem2.s5,2017_ece_sem2.g5,2017_ece_sem2.s6,2017_ece_sem2.g6,2017_ece_sem2.s7,2017_ece_sem2.g7,2017_ece_sem1.s1,2017_ece_sem1.g1,2017_ece_sem1.s2,2017_ece_sem1.g2,2017_ece_sem1.s3,2017_ece_sem1.g3,2017_ece_sem1.s4,2017_ece_sem1.g4,2017_ece_sem1.s5,2017_ece_sem1.g5,2017_ece_sem1.s6,2017_ece_sem1.g6 FROM 2017_ece,2017_ece_sem2,2017_ece_sem1 WHERE 2017_ece.enrollmentid=? and 2017_ece_sem2.enrollmentid=? and 2017_ece_sem1.enrollmentid=?";
              ...
              <tr>
               <%
                ...
                <%
                    ...
                    for(int i=0;i<13;i++)
                    {
                        totalcc=totalcc+c.getCourseCredit(rs.getString(k),filePath);
                        k=k+2;
                    }
                %>
                <td><%=totalcc%></td>
