...
<%@page import="SystemControllers.dao.DBAO"%>
...
String strDate= formatter.format(date);
      ...
      <% 
           DBAO conObj=new DBAO();
            ...
            if(con!=null)
            {
                String query="SELECT 2016_ece.*, 2016_ece_sem4.s1,2016_ece_sem4.g1, 2016_ece_sem4.s2,2016_ece_sem4.g2, 2016_ece_sem4.s3,2016_ece_sem4.g3, 2016_ece_sem4.s4,2016_ece_sem4.g4, 2016_ece_sem4.s5,2016_ece_sem4.g5, 2016_ece_sem4.s6,2016_ece_sem4.g6, 2016_ece_sem4.s7,2016_ece_sem4.g7, 2016_ece_sem3.s1,2016_ece_sem3.g1, 2016_ece_sem3.s2,2016_ece_sem3.g2, 2016_ece_sem3.s3,2016_ece_sem3.g3, 2016_ece_sem3.s4,2016_ece_sem3.g4, 2016_ece_sem3.s5,2016_ece_sem3.g5, 2016_ece_sem3.s6,2016_ece_sem3.g6, 2016_ece_sem3.s7,2016_ece_sem3.g7, 2016_ece_sem2.s1,2016_ece_sem2.g1, 2016_ece_sem2.s2,2016_ece_sem2.g2, 2016_ece_sem2.s3,2016_ece_sem2.g3, 2016_ece_sem2.s4,2016_ece_sem2.g4, 2016_ece_sem2.s5,2016_ece_sem2.g5, 2016_ece_sem2.s6,2016_ece_sem2.g6, 2016_ece_sem2.s7,2016_ece_sem2.g7, 2016_ece_sem1.s1,2016_ece_sem1.g1, 2016_ece_sem1.s2,2016_ece_sem1.g2, 2016_ece_sem1.s3,2016_ece_sem1.g3, 2016_ece_sem1.s4,2016_ece_sem1.g4, 2016_ece_sem1.s5,2016_ece_sem1.g5, 2016_ece_sem1.s6,2016_ece_sem1.g6 FROM 2016_ece,2016_ece_sem4,2016_ece_sem3,2016_ece_sem2,2016_ece_sem1 WHERE 2016_ece.enrollmentid=? AND 2016_ece_sem4.enrollmentid=? AND 2016_ece_sem3.enrollmentid=? AND 2016_ece_sem2.enrollmentid=? AND 2016_ece_sem1.enrollmentid=?";
                ...
                String filePath="C:/Users/user/Desktop/Results.exe/Data/Courses.xls";
                Course c=new Course();
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><%= c.getCourseName(rs.getString(3),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(3),filePath)%></td>
                <td><%=rs.getString(4)%></td>
              </tr>
              <tr>
                 <td><%=rs.getString(5)%></td>
                <td><%= c.getCourseName(rs.getString(5),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(5),filePath)%></td>
                <td><%=rs.getString(6)%></td>
              </tr>
              <tr>
                <td><%=rs.getString(7)%></td>
                <td><%= c.getCourseName(rs.getString(7),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(7),filePath)%></td>
                <td><%=rs.getString(8)%></td>
              </tr>
              <tr>
                <td><%=rs.getString(9)%></td>
                <td><%= c.getCourseName(rs.getString(9),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(9),filePath)%></td>
                <td><%=rs.getString(10)%></td>
              </tr>

              <tr>
                <td><%=rs.getString(11)%></td>
                <td><%= c.getCourseName(rs.getString(11),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(11),filePath)%></td>
                <td><%=rs.getString(12)%></td>
              </tr>
              <tr>
                <td><%=rs.getString(13)%></td>
                <td><%= c.getCourseName(rs.getString(13),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(13),filePath)%></td>
                <td><%=rs.getString(14)%></td>
              </tr>
              <tr>
                <td><%=rs.getString(15)%></td>
                <td><%= c.getCourseName(rs.getString(15),filePath)%></td>
                <td><%=c.getCourseCredit(rs.getString(15),filePath)%></td>
            ...
            <tbody>
              ...
              <tr>
                 <%
                    ...
                    for(int i=0;i<7;i++)
                    {
                        totalc=totalc+c.getCourseCredit(rs.getString(j),filePath);
                        j=j+2;
                    }
                %>
                <td><%=totalc%></td>
                <%
                    ...
                    for(int i=0;i<7;i++)
                    {
                        gradePoint=gradePoint+c.getCourseCredit(rs.getString(j1),filePath)*d.gradeToGradePoint(rs.getString(j2));
                        j1=j1+2;
                        j2=j2+2;
                    }
                ...
                <td><%=sgpa%></td>
                 <%
                    ...
                    for(int i=0;i<27;i++)
                    {
                        totalcc=totalcc+c.getCourseCredit(rs.getString(j),filePath);
                        j=j+2;
                    }
                %>
                <td><%=totalcc%></td>
                  <%
                    ...
                    for(int i=0;i<27;i++)
                    {
                        gradePointc=gradePointc+c.getCourseCredit(rs.getString(j1),filePath)*d.gradeToGradePoint(rs.getString(j2));
                        j1=j1+2;
                        j2=j2+2;
                    }
