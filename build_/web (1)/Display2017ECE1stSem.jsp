          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><%=sgpa%></td>
                <%
                   float totalCreditsRegistered=totalc; 
                %>
                <td><%=totalCreditsRegistered%></td>
                <%
